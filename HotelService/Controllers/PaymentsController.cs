...
namespace HotelService.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,Name,Amount,IsPaid,PaymentDate,ReservationId")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,Name,Amount,IsPaid,PaymentDate,ReservationId")] Payment payment)
        {
