...
namespace HotelService.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReservationId,StartDate,EndDate,RoomId,GuestId")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservationId,StartDate,EndDate,RoomId,GuestId")] Reservation reservation)
        {
